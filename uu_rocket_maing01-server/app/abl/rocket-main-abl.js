...
const Errors = require("../api/errors/rocket-main-error.js");
...
const logger = LoggerFactory.get("RocketMainAbl");
...
module.exports = new RocketMainAbl();
